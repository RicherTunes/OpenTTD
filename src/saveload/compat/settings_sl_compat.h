...
const SaveLoadCompat _settings_sl_compat[] = {
	...
	SLC_VAR("game_creation.continent_shape"),
	SLC_VAR("game_creation.terrain_algorithm"),
	SLC_VAR("game_creation.biome_model"),
	SLC_VAR("game_creation.town_distribution"),
	SLC_VAR("game_creation.amount_of_lakes"),
	SLC_VAR("game_creation.amount_of_mountain_ranges"),
	SLC_VAR("locale.currency"),
	SLC_VAR("units"),
